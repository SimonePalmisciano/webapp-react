function AboutPage() {
    return (
        <div className="bg-jurassik-sand">
            {/* Sezione iniziale */}
            <section
                className="py-5 text-light bg-jurassik-green"
                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-lg-4 mt-4 mt-lg-0">
                            <div
                                className="p-4 rounded-4 shadow bg-jurassik-dark"
                            >
            ...
            {/* Panini e menu */}
            <section className="py-5 bg-jurassik-sand-dark">
                <div className="container">
                    <div className="text-center mb-5">
                        <h2 className="fw-bold text-jurassik-dark">
                    ...
                    <div className="row g-4">
                        <div className="col-12 col-md-4">
                            <div className="card h-100 shadow-sm border-0 rounded-4">
                                <div className="card-body p-4">
                                    <h4 className="fw-bold mb-3 text-jurassik-dark">
                                        Panini giganti
                                    </h4>
                                    <p className="mb-0">
                ...
                <div className="container">
                    <div className="row align-items-center g-4">
                        <div className="col-12 col-lg-7">
                            <h2 className="fw-bold mb-3 text-jurassik-dark" >
                        ...
                        <div className="col-12 col-lg-5">
                            <div
                                className="p-4 rounded-4 shadow text-light bg-jurassik-green"
                            >
